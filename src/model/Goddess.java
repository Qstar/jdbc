...
public class Goddess {
    ...
    public Goddess(Integer id, String user_name, Integer sex, Integer age, Date birthday, String email, String mobile, String create_user, String update_user, Date create_date, Date update_date, Integer isdel) {
        this.id = id;
